(function(){
    ...
    function initText() {
        text = new createjs.Text("t", "80px 'Source Sans Pro'", "#F3EFE0");
    ...
    function showBaby() {
        var baby = ['生日快乐', '小笨猪', '拥有你', '是我', '一生', '最大的', '幸福', '有你', '陪伴', '的岁月', '是我', '最幸福', '的时刻！'];
        var timer = 0;
        _.forEach(baby, function(love, index) {
            timer = 6000 * (index + 1);
            setTimeout(function() {
                createText(love.toUpperCase());
            }, timer);
            setTimeout(function() {
                explode();
            }, timer + 3500)
